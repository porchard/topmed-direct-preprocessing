...
process sort_and_tabix {
    ...
    """
    lift-cis-eqtl-significant.py $direct $hg38_fasta $hg19_fasta $chain > direct.unsorted.txt
...
workflow {
    sort_and_tabix(Channel.fromPath(params.direct), Channel.fromPath(params.hg38_fasta), Channel.fromPath(params.hg19_fasta), Channel.fromPath(params.chain))
}